...
/**
 * The main class for Xor.
 * This is a program that defines the Xor operator, evaluates an expression,
...
public class Xor extends BinaryExpression implements Expression {
    ...
    /**
     * This method is a constructor of the Xor class.
     * The method Defines the class members.
     *
     * @param leftExp This is the expression on the left side of the Xor operator
     * @param rightExp This is the expression on the right side of the Xor operator
     */
    ...
    public Expression assign(String var, Expression expression) {
        ...
        return new Xor(leftExp, rightExp);
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nand operation.
    public Expression nandify() {
        return new Nand(new Nand(super.getLeftExp(), new Nand(super.getLeftExp(), super.getRightExp())), new Nand(super.getRightExp()
