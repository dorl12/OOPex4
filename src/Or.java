...
/**
 * The main class for Or.
 * This is a program that defines the Or operator, evaluates an expression,
...
public class Or extends BinaryExpression implements Expression {
    ...
    /**
     * This method is a constructor of the Or class.
     * The method Defines the class members.
     *
     * @param leftExp This is the expression on the left side of the Or operator
     * @param rightExp This is the expression on the right side of the Or operator
     */
    ...
    public Expression nandify() {
        return new Nand(new Nand(super.getLeftExp(), super.getLeftExp()), new Nand(super.getRightExp(), super.getRightExp()));
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nor operation.
    public Expression norify() {
        return new Nor(new Nor(super.getLeftExp(), super.getRightExp()), new Nor(super.getLeftExp(), super.getRightExp()));
    }
    ...
    public Expression simplify() {
        ...
        try {
            ...
            if (rightExpression.toString().equals("T") || leftExpression.toString().equals("T")) {
                return new Val(true);
            }
