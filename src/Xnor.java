...
/**
 * The main class for Xnor.
 * This is a program that defines the Xnor operator, evaluates an expression,
...
public class Xnor extends BinaryExpression implements Expression {
     ...
     *
     * @param leftExp This is the expression on the left side of the Xnor operator
     * @param rightExp This is the expression on the right side of the Xnor operator
     */
    ...
    public Boolean evaluate(Map<String, Boolean> assignment) throws Exception {
        ...
        return leftExpValue && rightExpValue || (!leftExpValue && !rightExpValue);
    }
    ...
    public Expression assign(String var, Expression expression) {
        ...
        return new Xnor(leftExp, rightExp);
    }
    ...
    public Expression nandify() {
        return new Nand(new Nand(new Nand(super.getLeftExp(), super.getLeftExp()), new Nand(super.getRightExp(), super.getRightExp()))
                , new Nand(super.getLeftExp(), super.getRightExp()));
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nor operation.
    public Expression norify() {
        return new Nor(new Nor(super.getLeftExp(), new Nor(super.getLeftExp(), super.getRightExp())), new Nor(super.getRightExp()
                , new Nor(super.getLeftExp(), super.getRightExp())));
    }
