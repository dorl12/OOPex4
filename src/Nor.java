...
/**
 * The main class for Nor.
 * This is a program that defines the Nor operator, evaluates an expression,
...
public class Nor extends BinaryExpression implements Expression {
    ...
    /**
     * This method is a constructor of the Nor class.
     * The method Defines the class members.
     *
     * @param leftExp This is the expression on the left side of the Nor operator
     * @param rightExp This is the expression on the right side of the Nor operator
     */
    ...
    public String toString() {
        return super.toString().replace("$", "V");
    }
    ...
    public Expression assign(String var, Expression expression) {
        ...
        return new Nor(leftExp, rightExp);
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nand operation.
    public Expression nandify() {
        return new Nand(new Nand(new Nand(super.getLeftExp(), super.getLeftExp()), new Nand(super.getRightExp(), super.getRightExp()))
                , new Nand(new Nand(super.getLeftExp(), super.getLeftExp()), new Nand(super.getRightExp(), super.getRightExp())));
    }
    ...
    public Expression simplify() {
        ...
        try {
            ...
            if (leftExpression.toString().equals("T") || rightExpression.toString().equals("T")) {
                return new Val(false);
            }
            if (leftExpression.toString().equals("F")) {
                return new Not(rightExpression);
            }
            if (rightExpression.toString().equals("F")) {
